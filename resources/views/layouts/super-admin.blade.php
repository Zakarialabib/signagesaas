        ...
        <aside
            ...
            <div class="flex flex-col grow overflow-y-auto pt-5 pb-4">
                ...
                <nav class="px-2 space-y-1">
                    ...
                    <x-super-admin.nav-link :href="route('superadmin.devices')" :active="request()->routeIs('superadmin.devices*')" :icon="'<svg class=\'w-6 h-6 group-hover:scale-110 transition-transform text-gray-500 dark:text-gray-400\' fill=\'none\' viewBox=\'0 0 24 24\' stroke=\'currentColor\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'1.5\' d=\'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z\'/></svg>'">Device Management</x-super-admin.nav-link>
