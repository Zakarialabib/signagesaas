<div>
    <!-- Hero Section -->
    <div class="relative isolate overflow-hidden bg-linear-to-b from-gray-900 to-gray-800">
        <!-- Background pattern -->
        <div class="absolute inset-0 -z-10 opacity-30">
            <svg class="h-full w-full" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <pattern id="grid-pattern" width="32" height="32" patternUnits="userSpaceOnUse">
                        <path
                            d="M0 32L32 32M0 16L32 16M0 8L32 8M0 4L32 4M0 2L32 2M0 1L32 1M16 0L16 32M8 0L8 32M4 0L4 32M2 0L2 32M1 0L1 32"
        ...
        <div class="absolute -top-24 right-0 -z-10 transform-gpu blur-3xl" aria-hidden="true">
            <div class="aspect-1108/632 w-277 bg-linear-to-r from-violet-600/20 to-purple-800/40 opacity-25"
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            ...
            <div class="mt-16 sm:mt-24 lg:mt-0 lg:flex-1">
                <div class="relative aspect-4/3 overflow-hidden rounded-xl shadow-2xl lg:rounded-2xl">
                    <img src="https://plus.unsplash.com/premium_photo-1658506825154-2598e6342809?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        alt="Digital signage display in a modern retail environment"
                        class="absolute inset-0 h-full w-full object-cover">
                    <div class="absolute inset-0 bg-linear-to-t from-gray-900/50 to-gray-900/0"></div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mt-16 grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div
                    ...
                    <div class="relative">
                        <div
                            class="flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-600/10 text-purple-400">
                ...
                <div
                    ...
                    <div class="relative">
                        <div
                            class="flex h-16 w-16 items-center justify-center rounded-2xl bg-pink-600/10 text-pink-400">
                ...
                <div
                    ...
                    <div class="relative">
                        <div
                            class="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-600/10 text-blue-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-12">
                    ...
                    <div class="relative mx-auto lg:mx-0 max-w-md lg:max-w-none">
                        ...
                        <div
                            ...
                            <img src="https://images.unsplash.com/photo-1586880244406-556ebe35f282?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80"
                                alt="Digital signage display interface"
                        ...
                        <!-- Floating Card 1 -->
                        <div
                            class="absolute -right-8 -top-8 z-20 max-w-xs rounded-2xl bg-purple-500/10 backdrop-blur-sm p-6 shadow-lg ring-1 ring-purple-500/20 transition-transform hover:-translate-y-1 duration-300">
                            <div class="flex items-center gap-x-4">
                                ...
                                <h3 class="text-base font-semibold text-white">Multi-screen layouts</h3>
                            </div>
                            <p class="mt-2 text-sm text-gray-300">Create custom layouts for different screen
                                orientations and sizes.</p>
                        </div>

                        <!-- Floating Card 2 -->
                        <div
                            class="absolute -bottom-8 -left-8 z-20 max-w-xs rounded-2xl bg-pink-500/10 backdrop-blur-sm p-6 shadow-lg ring-1 ring-pink-500/20 transition-transform hover:translate-y-1 duration-300">
                            <div class="flex items-center gap-x-4">
                                ...
                                <h3 class="text-base font-semibold text-white">Smart scheduling</h3>
                            </div>
                            <p class="mt-2 text-sm text-gray-300">Schedule content by time, date, or location for
    ...
    <section class="relative isolate overflow-hidden bg-gradient-to-br from-gray-900 to-purple-900 py-24 sm:py-32">
        ...
        <div class="absolute inset-0 -z-10">
            <div class="absolute left-1/2 top-0 -ml-24 transform-gpu blur-3xl lg:ml-24 xl:ml-48" aria-hidden="true">
                <div class="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-purple-600 to-pink-600 opacity-30"
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-300">
                    Experience the future of digital signage with our dynamic, TV-friendly web app. Engage your audience
                    with real-time content that captivates.
                </p>
            ...
            <!-- Demo Cards Section -->
            <div id="demos" class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
                <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-2">
                    ...
                    <div
                        ...
                        <div
                            class="absolute -inset-1 rounded-3xl bg-gradient-to-r from-purple-600/30 to-pink-600/30 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                        </div>
                        <div class="relative">
                            <div class="flex items-center gap-x-4">
                                <div
                                ...
                                <h3 class="text-xl font-semibold leading-7 text-white">Interactive Dashboard</h3>
                            </div>
                            <p class="mt-4 text-gray-300">
                                Our comprehensive dashboard combines multiple widgets into a single, cohesive display
                                perfect for lobbies, waiting areas, and control rooms.
                            </p>
                            <div class="mt-6 flex flex-wrap gap-4">
                                <div
                                    class="flex items-center rounded-full bg-gray-800/50 px-3 py-1 text-xs font-medium text-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="mr-1 h-3 w-3 text-purple-400">
                                        <path fill-rule="evenodd"
                            ...
                            <a href="{{ route('tenant.tv.display') }}"
                                class="mt-8 inline-flex items-center gap-x-1.5 text-sm font-semibold text-white hover:text-purple-300 transition-colors">
                                View display Demo
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="h-4 w-4">
                                    <path fill-rule="evenodd"
                    ...
                    <div
                        class="group relative rounded-3xl bg-white/5 p-6 shadow-2xl backdrop-blur-sm transition-all hover:scale-[1.02]">
                        <div
                            class="absolute -inset-1 rounded-3xl bg-gradient-to-r from-teal-600/30 to-cyan-600/30 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                        </div>
                        <div class="relative">
                            <div class="flex items-center gap-x-4">
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-full bg-teal-600/10 text-teal-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="h-7 w-7">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <h3 class="text-xl font-semibold leading-7 text-white">Focused Widget View</h3>
                            </div>
                            <p class="mt-4 text-gray-300">
                                Maximize impact with full-screen widget displays perfect for targeted messaging, weather
                                forecasts, or social media walls in high-traffic areas.
                            </p>
                            <div class="mt-6 flex flex-wrap gap-4">
                                <div
                                    class="flex items-center rounded-full bg-gray-800/50 px-3 py-1 text-xs font-medium text-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="mr-1 h-3 w-3 text-teal-400">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"
                                            clip-rule="evenodd" />
                                    </svg>
                            ...
                            <div class="mt-8 flex flex-wrap gap-3">
                                <a href="{{ route('tenant.tv.widget', ['category' => 'weather']) }}"
                                    class="inline-flex items-center gap-x-1.5 text-sm font-semibold text-white hover:text-teal-300 transition-colors">
                                    Weather Demo
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="h-4 w-4">
                                        <path fill-rule="evenodd"
                                ...
                                <a href="{{ route('tenant.tv.widget', ['category' => 'news']) }}"
                                    class="inline-flex items-center gap-x-1.5 text-sm font-semibold text-white hover:text-teal-300 transition-colors">
                                    News Demo
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="h-4 w-4">
                                ...
                                <a href="{{ route('tenant.tv.widget', ['category' => 'social']) }}"
                                    class="inline-flex items-center gap-x-1.5 text-sm font-semibold text-white hover:text-teal-300 transition-colors">
                                    Social Demo
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="h-4 w-4">
            ...
            <div class="mx-auto mt-24 max-w-2xl lg:text-center">
                <h2 class="text-base font-semibold leading-7 text-purple-400">Coming Soon</h2>
                <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Exciting New Features</p>
                <p class="mt-6 text-lg leading-8 text-gray-300">
                    We're constantly innovating to bring you the best digital signage experience.
                </p>
            </div>
            <div class="mx-auto mt-10 max-w-2xl lg:max-w-none">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
                    <div
                        class="rounded-2xl bg-white/5 p-8 text-center shadow-lg backdrop-blur-sm border border-white/10">
                        <div
                            class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-purple-600/10 text-purple-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <h3 class="mt-6 text-lg font-semibold leading-7 text-white">Employee Recognition</h3>
                        <p class="mt-2 text-sm leading-6 text-gray-400">
                            Celebrate your team with dynamic recognition displays featuring photos, achievements, and
                            milestones.
                        </p>
                    </div>
                    <div
                        class="rounded-2xl bg-white/5 p-8 text-center shadow-lg backdrop-blur-sm border border-white/10">
                        <div
                            class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-teal-600/10 text-teal-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                        ...
                        <h3 class="mt-6 text-lg font-semibold leading-7 text-white">Data Visualization</h3>
                        <p class="mt-2 text-sm leading-6 text-gray-400">
                            Beautiful real-time data dashboards that make complex information instantly understandable.
                        </p>
                    </div>
                    <div
                        class="rounded-2xl bg-white/5 p-8 text-center shadow-lg backdrop-blur-sm border border-white/10">
                        <div
                            class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-pink-600/10 text-pink-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <h3 class="mt-6 text-lg font-semibold leading-7 text-white">Interactive Kiosks</h3>
                        <p class="mt-2 text-sm leading-6 text-gray-400">
                            Touch-enabled displays with wayfinding, directories, and self-service options.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex justify-center">
                <div class="relative inline-flex items-center rounded-full border border-gray-600 p-1"
                    ...
                    <button type="button" class="relative px-4 py-2 text-sm rounded-full transition-all duration-200"
                        ...
                        Yearly
                        <span
                            class="absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-purple-400 text-[10px] font-medium text-white">-20%</span>
                    </button>
                </div>
            </div>
                            ...
                            <ul class="mt-8 space-y-4 text-sm text-gray-300">
                                <li class="flex items-center">
                                    ...
                                    <span class="ml-3"><span
                                            class="font-medium text-white">{{ $plan->max_devices }}</span>
                                        Devices</span>
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 shrink-0 text-purple-400" viewBox="0 0 20 20"
                                    ...
                                    <span class="ml-3"><span
                                            class="font-medium text-white">{{ $plan->max_screens }}</span>
                                        Screens</span>
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 shrink-0 text-purple-400" viewBox="0 0 20 20"
                                    ...
                                    <span class="ml-3"><span
                                            class="font-medium text-white">{{ $plan->max_users }}</span> Users</span>
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 shrink-0 text-purple-400" viewBox="0 0 20 20"
                                        fill="currentColor">
                                    ...
                                    <span class="ml-3"><span
                                            class="font-medium text-white">{{ number_format($plan->max_storage_mb / 1024, 1) }}
                                            GB</span> Storage</span>
                                </li>
    ...
    <div id="contact" class="relative isolate bg-gray-900">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                ...
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    <div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2">
                        <svg class="absolute inset-0 h-full w-full stroke-gray-700 mask-[radial-gradient(100%_100%_at_top_right,white,transparent)]"
                            aria-hidden="true">
                            <defs>
                                <pattern id="contact-pattern" width="200" height="200" x="100%" y="-1"
                    ...
                    <dl class="mt-10 space-y-6 text-base leading-7 text-gray-300">
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                                ...
                                <svg class="h-7 w-6 text-purple-400" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
                                </svg>
                            </dt>
                            <dd>123 Innovation Street<br>Casablanca, Morocco</dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a href="tel:+212-500-000000" class="hover:text-white transition-colors">+212 500
                                    000000</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a href="mailto:contact@signagesaas.com"
                                    class="hover:text-white transition-colors">contact@signagesaas.com</a></dd>
                        </div>
                    </dl>

                    <div class="mt-10 flex gap-x-6">
                        <a href="#" class="group" aria-label="Facebook">
                            <svg class="h-6 w-6 text-gray-400 group-hover:text-purple-400 transition-colors"
                        ...
                        <a href="#" class="group" aria-label="Twitter">
                            <svg class="h-6 w-6 text-gray-400 group-hover:text-purple-400 transition-colors"
                                fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
            ...
            <form wire:submit.prevent="contact" class="px-6 pt-20 pb-24 sm:pb-32 lg:px-8">
