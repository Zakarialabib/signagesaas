<div>
    <x-modal wire:model="showModal" title="Edit Schedule">
            ...
            <div class="p-6">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input wire:model="end_time" id="end_time" type="time" class="mt-1 block w-full"
                            required />
                ...
                <div class="mt-4">
                    ...
                    <input wire:model="priority" id="priority" type="number" class="mt-1 block w-full"
                        min="0" required />
