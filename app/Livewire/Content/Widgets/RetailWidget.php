...
use App\Tenant\Models\Content; // Assuming you might load product content similarly to menu content
    ...
    public function mount(
        ...
        if ($this->contentId) {
            ...
            if ($contentModel && isset($contentModel->content_data['widget_type']) && $contentModel->content_data['widget_type'] === 'RetailWidget') {
                ...
                $this->error = $this->error ?? "Content ID {$this->contentId} not found or not a RetailWidget.";
            }
